...
{return s.replace((new RegExp((function (){var G__16326 = match;return goog.string.regExpEscape(G__16326);
})(),"g")),replacement);
} else
...
{{
var G__16327 = cljs.core.pop(v__$1);
v__$1 = G__16327;
continue;
}
} else
...
{var pred__16335 = cljs.core._EQ_;var expr__16336 = limit;if(cljs.core.truth_((function (){var G__16338 = (1);var G__16339 = expr__16336;return (pred__16335.cljs$core$IFn$_invoke$arity$2 ? pred__16335.cljs$core$IFn$_invoke$arity$2(G__16338,G__16339) : pred__16335.call(null,G__16338,G__16339));
})()))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_((function (){var G__16340 = (2);var G__16341 = expr__16336;return (pred__16335.cljs$core$IFn$_invoke$arity$2 ? pred__16335.cljs$core$IFn$_invoke$arity$2(G__16340,G__16341) : pred__16335.call(null,G__16340,G__16341));
})()))
...
var G__16345 = s__$1.substring((index + cljs.core.count(m)));
var G__16346 = (limit__$1 - (1));
var G__16347 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__16345;
limit__$1 = G__16346;
parts = G__16347;
continue;
...
*/
clojure.string.trim = (function trim(s){var G__16349 = s;return goog.string.trim(G__16349);
});
/**
* Removes whitespace from the left side of string.
*/
clojure.string.triml = (function triml(s){var G__16351 = s;return goog.string.trimLeft(G__16351);
});
/**
* Removes whitespace from the right side of string.
*/
clojure.string.trimr = (function trimr(s){var G__16353 = s;return goog.string.trimRight(G__16353);
});
/**
...
*/
clojure.string.blank_QMARK_ = (function blank_QMARK_(s){var G__16356 = s;return goog.string.isEmptySafe(G__16356);
});
/**
...
{var ch = s.charAt(index);var temp__4124__auto___16357 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(cmap,ch);if(cljs.core.truth_(temp__4124__auto___16357))
{var replacement_16358 = temp__4124__auto___16357;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_16358)));
} else
{buffer.append(ch);
}
{
var G__16359 = (index + (1));
index = G__16359;
continue;
}
}
