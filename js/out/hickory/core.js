...
goog.require('hickory.utils');
hickory.core.HiccupRepresentable = (function (){var obj7328 = {};return obj7328;
})();
...
{var x__4277__auto__ = (((this$ == null))?null:this$);return (function (){var or__3640__auto__ = (hickory.core.as_hiccup[goog.typeOf(x__4277__auto__)]);if(or__3640__auto__)
...
hickory.core.HickoryRepresentable = (function (){var obj7330 = {};return obj7330;
})();
...
{var x__4277__auto__ = (((this$ == null))?null:this$);return (function (){var or__3640__auto__ = (hickory.core.as_hickory[goog.typeOf(x__4277__auto__)]);if(or__3640__auto__)
{return or__3640__auto__;
} else
...
(hickory.core.as_hiccup["object"] = (function (this$){var pred__7332 = cljs.core._EQ_;var expr__7333 = (this$["nodeType"]);if(cljs.core.truth_(pred__7332.call(null,hickory.core.Attribute,expr__7333)))
...
(hickory.core.as_hickory["object"] = (function (this$){var pred__7335 = cljs.core._EQ_;var expr__7336 = (this$["nodeType"]);if(cljs.core.truth_(pred__7335.call(null,hickory.core.Attribute,expr__7336)))
{return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword.call(null,(this$["name"])),(this$["value"])], null);
} else
{if(cljs.core.truth_(pred__7335.call(null,hickory.core.Comment,expr__7336)))
...
{if(cljs.core.truth_(pred__7335.call(null,hickory.core.Document,expr__7336)))
...
{if(cljs.core.truth_(pred__7335.call(null,hickory.core.DocumentType,expr__7336)))
...
{if(cljs.core.truth_(pred__7335.call(null,hickory.core.Element,expr__7336)))
...
{if(cljs.core.truth_(pred__7335.call(null,hickory.core.Text,expr__7336)))
{return (this$["wholeText"]);
} else
{throw (new Error(("No matching clause: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__7336))));
}
}
}
}
...
hickory.core.extract_doctype = (function extract_doctype(s){var temp__4126__auto__ = cljs.core.second.call(null,(function (){var or__3640__auto__ = cljs.core.re_find.call(null,/<!DOCTYPE ([^>]*)>/,s);if(cljs.core.truth_(or__3640__auto__))
{return or__3640__auto__;
} else
...
var temp__4126__auto___7338 = cljs.core.first.call(null,(doc["head"]["childNodes"]));if(cljs.core.truth_(temp__4126__auto___7338))
{var title_el_7339 = temp__4126__auto___7338;if(cljs.core.empty_QMARK_.call(null,(title_el_7339["text"])))
{hickory.core.remove_el.call(null,title_el_7339);
} else
{}
} else
{}
...
*/
hickory.core.parse = (function parse(s){var or__3640__auto__ = hickory.core.parse_dom_with_domparser.call(null,s);if(cljs.core.truth_(or__3640__auto__))
{return or__3640__auto__;
} else
